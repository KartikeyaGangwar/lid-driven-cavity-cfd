...
**Manuscript Title:**  
High-Resolution Finite-Difference Benchmarks for the 2D Lid-Driven Cavity Flow up to $Re = 100,000$: Exact Discrete Sine Transform, Batchelor Core Slices, and Hopf Bifurcation Cascades  
...
We are pleased to submit our original research manuscript entitled **"High-Resolution Finite-Difference Benchmarks for the 2D Lid-Driven Cavity Flow up to $Re = 100,000$: Exact Discrete Sine Transform, Batchelor Core Slices, and Hopf Bifurcation Cascades"** for consideration as a regular research paper in *Computers & Fluids*.
